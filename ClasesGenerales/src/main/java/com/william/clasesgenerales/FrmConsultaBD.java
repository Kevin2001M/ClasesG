...
public class FrmConsultaBD extends javax.swing.JFrame {
    ...
    public void CargarNota() {
        ...
        int idM = Valuemenber[cbMate.getSelectedIndex()];
    ...
    public void CargarMateria() {
        Materias Estu = new Materias();
        ArrayList<Materia> Materia = Estu.ListadoMaterias();
        ...
        Valuemenber = new int[Materia.size()];

        int intContador = 0;

        while (iterator.hasNext()) {
            Materia matCls;
            matCls = (Materia) iterator.next();
            Valuemenber[intContador] = matCls.getIdmateria();

            DefaultComboBoxModel.addElement(matCls.getNombreMateria());
            intContador++;

        }
        cbMate.setModel(DefaultComboBoxModel);
    }
    ...
    private void initComponents() {
        ...
        cbMate = new javax.swing.JComboBox<>();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 375, Short.MAX_VALUE)
        ...
        cbMate.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(cbMate, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jLabel5)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cbMate, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(52, 52, 52)
                .addComponent(jLabel6)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Nota nota = new Nota();
        Materias esDao = new Materias();

        nota.setIdEstudiante(idEstudiantes[cbEstu.getSelectedIndex()]);
        nota.setIdmateria(idMaterias[cbMate.getSelectedIndex()]);
        
//        int id = Valuemeber[cbEstu.getSelectedIndex()];
        //JOptionPane.showMessageDialog(null, "Id Estudiante: " + id);
//        int idM = Valuemenber[cbMate.getSelectedIndex()];
        //JOptionPane.showMessageDialog(null, "Id Materia: " + idM);
     

        nota.setNota(txtNota.getText());

        esDao.AddMateria(nota);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        e.setFechadeNcimiento(jDateChooser2.getDate());
    ...
    private javax.swing.JComboBox<String> cbMate;
